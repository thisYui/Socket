...
class Client:
    ...
    def thread_scan_file(self):
        while self.is_live:
            ...
            logging.info(f"Scan files: {self.files_scan}")
            logging.info(f"Files : {self.files['waiting']}")
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                logging.error(f"Data size Error: {e}")
                print(f"Data size Error: {e}")
                break
